// defaultMoneySmartCategories.js
// ============================================================================
// MoneySmart Reference Categories (READ-ONLY)
// ---------------------------------------------------------------------------
// ❌ NOT stored in IndexedDB
// ❌ NOT shown in UI
// ✅ Used only for classification, mapping, and fallback intelligence
// ============================================================================

export const DEFAULT_MS_CATEGORIES = [
